...
public class RevisionService {
     ...
     */
    @Transactional
    public Revision finishedRevision(Long processId, Revision revision, List<MultipartFile> files) {
        ...
        process.setComments(revision.getComments());
    ...
    public Revision getRevisionByProcessId(Long processId) {
        return revisionRepo.findRevisionByProcessId(processId);
    }
}
